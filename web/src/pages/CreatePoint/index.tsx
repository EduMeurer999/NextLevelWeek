...
const CreatePoint = () => {
    ...
    const onDrop = useCallback((acceptedsFiles: File[]) => {
        let errors: number = 0;
        acceptedsFiles.map(file => {
            if (file.type !== "image/jpeg") {
                errors++;
            }
        });
        if(errors == 0){
            alert("Aquivos salvos com sucesso!");
        }else{
            
            let elem:HTMLElement | null = document.getElementById("drag-drop-image");            
            ...
            <form onSubmit={handleSubmit}>
                ...
                <fieldset>
                    ...
                    <div className="field-group">
                        <div className="field">
                            <label>Imagem: </label>
                            <div {...getRootProps()} id="drag-drop-image">
                                <input {...getInputProps()} />
                                {isDragActive ?
                                    <p>Solte seu arquivo aqui...</p> :
                                    <p>Arraste seu arquivo, ou clique para selecionar</p>
                                }
                            </div>
